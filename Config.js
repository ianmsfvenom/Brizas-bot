...
// solo cambie el número y no elimine @ s.whatsapp.net
...
// Texto en el menú de imágenes cuando la bienvenida está activada
// Nota: no pongas el texto largo para que la imagen no desaparezca

const titlemenumsgimg = 'BIENVENIDO'
// Título en el menú de la imagen cuando la bienvenida está activada
// Nota: no pongas el texto largo para que la imagen no desaparezca
...
// Enlace de imagen de fondo de bienvenida directa TAMAÑO RECOMENDADO: 1280x720
// Nota: no pongas el texto largo para que la imagen no desaparezca

const backgroundbyeimg = `https: // i.imgur.com / 2TCj9ri.jpg`
// Enlace directo desde la imagen de fondo de las despedidas TAMAÑO RECOMENDADO: 1280x720
// Nota: no pongas el texto largo para que la imagen no desaparezca
...
// mensaje cuando el administrador envía tipos de mensajes prohibidos
...
// mensaje cuando el administrador envía una palabra prohibida por el bot
...
const notregister = `* Comando no registrado, escriba $ {prefijo} menú para ver la lista de comandos *`
